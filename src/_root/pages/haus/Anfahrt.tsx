const Anfahrt = () => {
  return (
    <div className="content-wrapper min-h-lvh">
      ...
      <div className="md:p-2 mt-4 w-full md:h-dvh">
        <iframe
          className="w-full md:h-4/6 h-80"
          id="gmap_canvas"
          src="https://maps.google.com/maps?width=520&amp;height=800&amp;hl=en&amp;q=CVJM-Freizeit%20und%20Segelzentrum%20Ratzeburg%20gemeinn%C3%BCtzige%20GmbH%20Berlin+(CVJM-Freizeit%20und%20Segelzentrum%20Ratzeburg%20gemeinn%C3%BCtzige%20GmbH)&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
        ></iframe>
        <script
